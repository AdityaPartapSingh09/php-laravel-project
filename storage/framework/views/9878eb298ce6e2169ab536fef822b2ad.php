<nav class="navbar">
            ...
            ?>
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<img class="wd-30 ht-30 rounded-circle" src="<?php echo e((!empty ($profileData->photo) )? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="profile">
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
										<img class="wd-80 ht-80 rounded-circle" src="<?php echo e((!empty ($profileData->photo) )? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="profile">
									</div>
                ...
                <ul class="list-unstyled p-1">
                  ...
                  <li class="dropdown-item py-2">
                    <a href="<?php echo e(route ('admin.change.password')); ?>" class="text-body ms-0">
			...
			</nav><?php /**PATH C:\xampp\htdocs\project-1\realestate\resources\views/admin/body/header.blade.php ENDPATH**/ ?>